                            ...
                            {currentData.map((record, index) => {
                                return (
                                    <tr key={index}>
                                        ...
                                        <th>{record.is_active == 1 ? <><Badge badgeContent={'Active'} color="success" sx={{ ml: 3 }}>

                                        </Badge></> : <Badge color='error' badgeContent={'Deactive'} sx={{ ml: 3 }}>
    ...
    return (
        <React.Fragment>
            <Row className="page-title">
                <Col md={12}>
                    <PageTitle
                        breadCrumbItems={[{ label: 'Owner', path: '/owner' }]}
                        title={'owner List'}
                    />
                </Col>
            </Row>
