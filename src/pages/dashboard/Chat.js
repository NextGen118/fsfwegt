...
const Chat = () => {
    const chatMessages = [
        ...
        { id: 4, userPic: profilePic, userName: 'Marine-system', text: "Wow that's great!", postedOn: '10:03' },
        { id: 5, userPic: profilePic, userName: 'Marine-system', text: 'Cool!', postedOn: '10:03' },
    ];
