...
const BilloflandingsubsTable = (props) => {
    ...
    const editBilloflandingsubs = (id) => {
        history.push(`edit-billoflandingsubnoninventories/${id}`)
    }
...
const Billoflandingsubs_non_inventoriesList = (props) => {

    const history = useHistory()

    const addBilloflandingsubsForm = () => {
        history.push("/add-billoflandingsubnoninventories");
    }
    ...
    return (
        <React.Fragment>
            <Row className="page-title">
                <Col>
                    <PageTitle
                        breadCrumbItems={[{ label: 'Bill of lading sub non inventories', path: '/billoflandingsubnoninventories' }]}
                        title={'Bill of lading subs non inventories List'}
                    />
                </Col>
            </Row>
            <Row>
...
export default Billoflandingsubs_non_inventoriesList;