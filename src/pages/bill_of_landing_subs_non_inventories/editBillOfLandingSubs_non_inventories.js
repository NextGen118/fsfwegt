...
const EditdBilloflandingsubs_non_inventories = (props) => {
    ...
    const [values, setValues] = useState({
        seal_no: '', marks: '', package_quantity: '', description: '', gross_weight: '', measurement: '',
    ...
    const getBilloflandingsubsByid = () => {
        axios.get(`${process.env.REACT_APP_BASE_URL}/billoflandingsubnoninventories/show/all`)
            .then(res => {
    ...
    const submitEdit = () => {
        axios.post(`${process.env.REACT_APP_BASE_URL}/billoflandingsubnoninventories/store?bill_of_landing_id=${billoflandingselect}
