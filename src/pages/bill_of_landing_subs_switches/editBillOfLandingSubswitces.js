...
const EditdBilloflandingsubswitches = (props) => {
    ...
    const submitEdit = () => {
        axios.post(`${process.env.REACT_APP_BASE_URL}/billoflandingsubswitches/store?bill_of_landing_id=${billoflandingselect}
        ...
        <React.Fragment>
            <Row className="page-title">
                <Col md={12}>
                    <PageTitle
                        breadCrumbItems={[
                            { label: 'Bill of lading sub switces', path: '/billoflandingsubswitches' },
                            { label: 'Edit bill of lading sub switch', path: '/edit-billoflandingsubswitches/:id', active: true },
                        ]}
                        title={'Edit Bill of lading sub switch'}
                    />
                </Col>
            </Row>
...
export default EditdBilloflandingsubswitches;