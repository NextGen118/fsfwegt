...
const AddSwaphistories = forwardRef((props,ref) =>{
    ...
    const onSubmit = () =>{
        axios.post(`http://127.0.0.1:8000/api/swaphistories/store?swap_id=${swapselect}&status=${activeselect}&equipment_id=${equipmentselect}&client_id_agent=${clientselect}`)
            .then(res=>{
                handleClose();
