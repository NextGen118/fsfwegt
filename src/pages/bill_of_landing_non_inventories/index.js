...
const BilloflandingsTable = (props) => {
    ...
    const editBilloflandings = (id) => {
        history.push(`edit-billoflandingnoninventories/${id}`)
    }
...
const Billoflandings_non_inventoriesList = (props) => {

    const history = useHistory()

    const addBilloflandingsForm = () => {
        history.push("/add-billoflandingnoninventories");
    }
    ...
    return (
        <React.Fragment>
            <Row className="page-title">
                <Col>
                    <PageTitle
                        breadCrumbItems={[{ label: 'Bill of lading non inventories', path: '/billoflandingnoninventories' }]}
                        title={'Bill of lading non inventories List'}
                    />
                </Col>
            </Row>
            <Row>
...
export default Billoflandings_non_inventoriesList;