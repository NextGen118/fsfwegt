...
const EditdBilloflandings_non_inventories = (props) => {
    ...
    const getBilloflandingsByid = () => {
        axios.get(`${process.env.REACT_APP_BASE_URL}/billoflandingnoninventories/show/all`)
            .then(res => {
    ...
    const submitEdit = () => {
        axios.post(`${process.env.REACT_APP_BASE_URL}/billoflandingnoninventories/store?date=${values.date}
