...
const AddReceipts = (props) =>{
    ...
    const getArrivalNotice = () => {
        axios.get(`http://127.0.0.1:8000/api/arivalnotices/show/all`)
            .then(res=>{
    ...
    const getDetentionInvoice = () => {
        axios.get(`http://127.0.0.1:8000/api/detentioninvoice/show/all`)
            .then(res=>{
    ...
    const onSubmit = () =>{
        axios.post(`http://127.0.0.1:8000/api/receipts/store?date=${values.date}&receipt_no=${values.receipt_no}&description=${values.description}&client_id=${clientselect}&arrival_notice_id=${arrivalNoticeselect}&invoice_id=${invoicesselect}&detention_invoice_id=${detentionInvoiceselect}&currency_id=${currencyselect}&status=${values.status}`)
