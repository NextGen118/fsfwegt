                ...
                <CardBody className="p-3">
                    <UncontrolledDropdown className="float-right">
                        ...
                        <DropdownMenu>
                            ...
                            <DropdownItem>
                                <i className="uil uil-user-plus mr-2"></i>Add People
                            </DropdownItem>
                            <DropdownItem className="text-warning">
                                <i className="uil uil-exit mr-2"></i>Leave
                            </DropdownItem>
            ...
            <React.Fragment>
                        ...
                        <Card>
                            <CardBody>
                                <Row className="align-items-center">
                                    <Col>
                                        <label className="font-weight-bold d-inline mr-2">
                                            <Briefcase
                                                className="icon-dual icon-xs mr-2"
                                                data-feather="hard-drive"></Briefcase>
                                            Project:{' '}
                                        </label>
                                        <UncontrolledDropdown className="d-inline">
                                            <DropdownToggle
                                                tag="a"
                                                className="dropdown-toggle p-0 arrow-none font-weight-bold cursor-pointer">
                                                Marine-system Design
                                                <i className="uil uil-angle-down font-size-16 align-middle ml-1"></i>
                                            </DropdownToggle>
                                            <DropdownMenu>
                                                <DropdownItem>
                                                    <HardDrive className="icon-dual icon-xs mr-2"></HardDrive>
                                                    Marine-system Design
                                                </DropdownItem>
                                                <DropdownItem>
                                                    <Briefcase
                                                        className="icon-dual icon-xs mr-2"
                                                        data-feather="briefcase"></Briefcase>
                                                    Development
                                                </DropdownItem>
                                                <DropdownItem divider />
                                                <DropdownItem>
                                                    <FolderPlus
                                                        className="icon-dual icon-xs mr-2"
                                                        data-feather="briefcase"></FolderPlus>
                                                    Marine-system Angular
                                                </DropdownItem>
                                                <DropdownItem>
                                                    <FolderPlus
                                                        className="icon-dual icon-xs mr-2"
                                    ...
                                    <Col className="col text-right">
                                        <Button color="primary" id="btn-new-event">
                                            <i className="uil-plus mr-1"></i>Add New
                                        </Button>
                                    </Col>
                                </Row>
                            </CardBody>
                ...
                <Row>
                    <Col>
                        ...
                        <div className="tasks border">
                            <h5 className="mt-0 task-header header-title">
                                In Progress <span className="font-size-13">({this.state.inProgessTasks.length})</span>
                            </h5>
                            <TaskContainer
                                id="task-list-two"
                                classNames="task-list-items"
