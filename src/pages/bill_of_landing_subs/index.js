...
const BilloflandingsubsTable = (props)=>{
    ...
    const editBilloflandingsubs = (id) =>{
        history.push(`edit-billoflandingsubs/${id}`)
    }
...
const BilloflandingsubsList = (props) => {

    const history = useHistory()
    
    const addBilloflandingsubsForm = () =>{
        history.push("/add-billoflandingsubs");
    }
    ...
    return(
        <React.Fragment>
            <Row className="page-title">
                <Col>
                    <PageTitle 
                        breadCrumbItems = {[{label:'Bill of landing subs', path: '/billoflandingsubs'}]}
                        title = {'Bill of landing subs List'}
                    />
                </Col>
            </Row>
            <Row>
...
export default BilloflandingsubsList;