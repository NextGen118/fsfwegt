            ...
            <Row>
                    ...
                    <Card>
                        <CardBody className="pb-0">
                            <div className="text-center mt-3">
                                <img src={avatarImg7} alt="" className="avatar-xl rounded-circle" />
                                <h5 className="mt-2 mb-0">Marine-system N</h5>
                                ...
                                <div className="mt-4 pt-3 border-top text-left">
                                    <p className="text-muted mb-2">
                                        Hi I'm Marine-system. I am user experience and user interface designer. I have
                ...
                <Col md={6} xl={3}>
                    <Card className="profile-widget">
                        <img src={avatarImg2} alt="Marine-system" className="card-img-top" />

                        <UncontrolledDropdown className="card-action float-right">
                            <DropdownToggle
                                tag="button"
                                className="dropdown-toggle arrow-none btn btn-link text-white p-0">
                        ...
                        <CardBody className="text-center p-0">
                            <div className="profile-info pb-3">
                                <img src={avatarImg7} alt="" className="img-thumbnail avatar-xl rounded-circle" />
                                <h5 className="mt-2 mb-0">Marine-system N</h5>
                                <h6 className="text-muted font-weight-normal mt-2 mb-4">User Experience Specialist</h6>
                                <button type="button" className="btn btn-primary btn-sm mr-1">
                                    Follow
                ...
                <Col md={6} xl={3}>
                    <Card>
                        <CardBody>
                            <Media>
                                <img src={avatarImg7} className="avatar-lg rounded-circle mr-2" alt="Marine-system" />
                                ...
                                <UncontrolledDropdown className="float-right">
                                    <DropdownToggle
                                        tag="button"
                                        className="dropdown-toggle arrow-none btn btn-link text-muted p-0">
                            ...
                            <div className="mt-2 mb-3 row justify-content-between">
                                <div className="col-sm-5">
                                    <span className="font-size-15">
                                        <i className="uil uil-calendar-alt mr-1"></i>40 Days Ago
                                    </span>
                                </div>
                                <div className="col-sm mt-2 mt-sm-0">
                                    <span className="font-size-15">
                                        <i className="uil uil-users-alt mr-1"></i>12,001
                                    </span>
                                </div>
                                <div className="col-sm mt-2 mt-sm-0 text-sm-right">
                                    <span className="font-size-15">
                                        <i className="uil uil-calendar-alt mr-1"></i>1200
                                    </span>
                                </div>
                            </div>
                            ...
                            <div className="mt-1 pt-2 border-top text-left">
                                <p className="text-muted mb-2">
                                    Hi I'm Marine-system. I am foodie and love to eat different cuisine!
                                </p>
                            </div>
                            ...
                            <div className="row mt-4 mb-3">
                                ...
                                <div className="col">
                                    <img src={img6} alt="" className="img-fluid rounded shadow" />
                                </div>
                            </div>

                            <div className="row mt-5 text-center">
                                <div className="col">
                                    <button type="button" className="btn btn-primary btn-block mr-1">
                                        Follow
                                    </button>
                                </div>
                                <div className="col">
                ...
                <Col md={6} xl={3}>
                    <Card>
                        <Row className="no-gutters">
                            <Col md={4}>
                                <img src={avatarImg7} className="card-img" alt="Marine-system" />
                            </Col>
                            <Col md={8}>
                                <CardBody>
                                    <h5 className="card-title mb-1">Marine-system N</h5>
                                    <h6 className="text-muted font-weight-normal mt-0 mb-3">New York, USA</h6>
                                    <div className="card-text row text-center">
                                        <div className="col">
                                            <button type="button" className="btn btn-primary btn-sm btn-block mr-1">
                                                Follow
                                            </button>
                                        </div>
                                        <div className="col">
                                            <button type="button" className="btn btn-white btn-sm btn-block">
                                                Message
                                            </button>
                                        </div>
                                    </div>
                    ...
                    <Card>
                        <CardBody className="p-3">
                            <Media>
                                <img src={avatarImg7} className="mr-3 avatar-lg rounded" alt="Marine-system" />
                                <Media body>
                                    <h5 className="mt-1 mb-0">Marine-system N</h5>
                                    <h6 className="font-weight-normal mt-1 mb-1">
                                        <a href="/">@Marine-system</a>
                                    </h6>
                            ...
                            <Row className="mt-3 text-center">
                                ...
                                <Col>
                                    <button type="button" className="btn btn-white btn-sm btn-block mr-1">
                                        Message
                                    </button>
                                </Col>
                            </Row>
