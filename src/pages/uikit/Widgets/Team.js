    ...
    return (
        <Card>
            <CardBody className="pt-2">
                ...
                <Member image={avatarImg7} name="Marine-system N" description="Senior Sales Guy" />
                    ...
                    <Col sm={6}>
                        <ul className="list-unstyled ml-sm-3 pl-sm-5 mt-4 mt-sm-0">
                            ...
                            <li className="mb-4">
                                ...
                                <h6 className="mt-1 font-size-16">Marine-system React Planning</h6>
                            </li>
                            <li>
...
const Chat = () => {
    const chatMessages = [
        { id: 1, userPic: avatarImg4, userName: 'Geneva', text: 'Hello!', postedOn: '10:00' },
        {
            id: 2,
            userPic: avatarImg7,
            userName: 'Marine-system',
            text: 'Hi, How are you? What about our next meeting?',
            postedOn: '10:01',
        },
        { id: 3, userPic: avatarImg4, userName: 'Geneva', text: 'Yeah everything is fine', postedOn: '10:02' },
        { id: 4, userPic: avatarImg7, userName: 'Marine-system', text: "Wow that's great!", postedOn: '10:03' },
        { id: 5, userPic: avatarImg7, userName: 'Marine-system', text: 'Cool!', postedOn: '10:03' },
    ];
            ...
            <CardBody className="pt-2 pb-3">
                ...
                <PerfectScrollbar style={{ maxHeight: '339px' }}>
                    <TaskList>
                        ...
                        <TaskItem
                            title="Write a release note for Marine-system"
                            due_date="24 Aug, 2019"
                            className="mt-2"
                        />
                        <TaskItem
                            title="Invite Greeva to a project Marine-system admin"
    ...
    <Card>
        <CardBody className="pt-2 pb-3">
            ...
            <Media className="mt-5">
                <img src={avatarImg7} className="mr-3 avatar rounded-circle" alt="Marine-system" />
                <Media body>
            ...
            <Media className="mt-3">
                <img src={avatarImg9} className="mr-3 avatar rounded-circle" alt="Marine-system" />
                <Media body>
                    <h6 className="mt-0 mb-0 font-size-15 font-weight-normal">
                        <a href="/" className="font-weight-bold">
                            Mannat
                        ...
                        <span className="font-weight-bold text-primary">Marine-system</span> on project{' '}
                        <span className="font-weight-bold text-primary">Admin</span>
                    </h6>
