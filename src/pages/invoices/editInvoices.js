        ...
        <React.Fragment>
            <Row className="page-title">
                <Col md={12}>
                    <PageTitle
                        breadCrumbItems={[
                            { label: 'Invoices', path: '/receipts' },
                            { label: 'Edit Invoices', path: '/receipts-add', active: true },
                        ]}
                        title={'Edit Invoices'}
                    />
                </Col>
